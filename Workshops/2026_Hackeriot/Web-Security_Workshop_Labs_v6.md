# Web security: From the protocol to exploiting vulnerabilities (Hackeriot Workshop)

## Tools

### Burp Suite Community Edition (Host Proxy)

Download Burp Suite Community Edition - PortSwigger [https://portswigger.net/burp/communitydownload](https://portswigger.net/burp/communitydownload)

### Wireshark (Network Analyzer)

[Wireshark • Go Deep | Download](https://www.wireshark.org/download.html)

### CyberChef (content manipulations)
...
- [https://](https://portswigger.net/web-security/file-path-traversal/lab-absolute-path-bypass)[portswigger.net/web-security/file-path-traversal/lab-absolute-path-bypass](https://portswigger.net/web-security/file-path-traversal/lab-absolute-path-bypass)
...
- Lior  [Lior Yakim | LinkedIn](https://il.linkedin.com/in/lior-yakim-79b100156)
